...
void main() {
  runApp(const MyAppVNPay());
}

class MyAppVNPay extends StatelessWidget {
  const MyAppVNPay({Key? key}) : super(key: key);
...
class _ExampleState extends State<Example> {
  ...
  void onPayment() async {
    final paymentUrl = VNPAYFlutter.instance.generatePaymentUrl(
      url:
          'https://sandbox.vnpayment.vn/paymentv2/Transaction/PaymentMethod.html?token=62b8347aaab64102a6bcbc4d2e010c89', 
      version: '2.0.1',
